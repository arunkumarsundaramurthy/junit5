	...
	enum Style implements DisplayNameGenerator {
		...
		DEFAULT {
			...
			public String generateDisplayNameForMethod(Class<?> testClass, Method testMethod) {
				...
				String types = ClassUtils.nullSafeToString(Class::getSimpleName, testMethod.getParameterTypes());
		...
		UNDERSCORE {
			...
			@Override
			public String generateDisplayNameForMethod(Class<?> testClass, Method testMethod) {
				return replaceUnderscore(DEFAULT.generateDisplayNameForMethod(testClass, testMethod));
			}
